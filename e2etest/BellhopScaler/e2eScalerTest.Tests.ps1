  ...
  Context "Deploying infrastructure" {
    It "Bellhop core infra deploys successfully in $Location" {
      $deploy = New-AzDeployment `
        ...
        -location $Location `
        -TemplateFile templates/azuredeploy2.json `
        -appName $AppName `
